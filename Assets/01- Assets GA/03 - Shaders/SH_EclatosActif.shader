...
Shader "Erebos/SH_EclatosActif"
{
	...
	SubShader
	{
		...
		{
			float4 color13 = IsGammaSpace() ? float4(0.05660379,0.05660379,0.05660379,0) : float4(0.004556417,0.004556417,0.004556417,0);
...
Node;AmplifyShaderEditor.ColorNode;13;39.26302,-105.918;Float;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;False;0;0.05660379,0.05660379,0.05660379,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F35BAC1C3B4A9233B8E751E8C6A8BAF65447B5F3